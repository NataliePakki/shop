...
export enum ProductsActionTypes {
  ...
  ADJUSTED_PRODUCT_COUNT = '[Products] ADJUSTED_PRODUCT_COUNT'
}
...
export class AdjustProductCount implements Action {
  readonly type = ProductsActionTypes.ADJUSTED_PRODUCT_COUNT;
